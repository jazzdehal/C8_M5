...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ...
        return [
            html.Div(className='chart_item', children=[html.Div(children=R_chart1),html.Div(children=R_chart2)],style={}),
            html.Div(className='chart-item', children=[html.Div(children=R_chart3),html.Div(R_chart4)],style={})
            ]   
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        avr_vdata=yearly_data.groupby('Vehicle_Type')['Automobile_Sales'].mean().reset.index()
